...
namespace NativeWifi
{
    ...
    public class WlanClient
    {
        ...
        {
            Wlan.ThrowIfError(
                Wlan.WlanOpenHandle(Wlan.WLAN_CLIENT_VERSION_XP_SP2, IntPtr.Zero, out negotiatedVersion,
                    out clientHandle));
            try
            {
                ...
                Wlan.ThrowIfError(
                    Wlan.WlanRegisterNotification(clientHandle, Wlan.WlanNotificationSource.All, false,
                        wlanNotificationCallback, IntPtr.Zero, IntPtr.Zero, out prevSrc));
            }
            catch
            {
        ...
        public WlanInterface[] Interfaces
        {
            get
            {
                ...
                {
                    var header =
                        (Wlan.WlanInterfaceInfoListHeader)
        ...
        private Wlan.WlanConnectionNotificationData? ParseWlanConnectionNotification(
        ...
        {
            var wlanIface = ifaces.ContainsKey(notifyData.interfaceGuid) ? ifaces[notifyData.interfaceGuid] : null;
            ...
            switch (notifyData.notificationSource)
            {
                case Wlan.WlanNotificationSource.ACM:
                    switch ((Wlan.WlanNotificationCodeAcm) notifyData.notificationCode)
                    {
                        ...
                        {
                            var expectedSize = Marshal.SizeOf(typeof(Wlan.WlanReasonCode));
                            if (notifyData.dataSize >= expectedSize)
                            {
        ...
        public class WlanInterface
        {
            ...
            {
                get { return (Wlan.WlanInterfaceState) GetInterfaceInt(Wlan.WlanIntfOpcode.InterfaceState); }
            }
            ...
            public int Channel
            {
                get { return GetInterfaceInt(Wlan.WlanIntfOpcode.ChannelNumber); }
            }
            ...
            public int RSSI
            {
                get { return GetInterfaceInt(Wlan.WlanIntfOpcode.RSSI); }
            }
            ...
            {
                get { return (Wlan.Dot11OperationMode) GetInterfaceInt(Wlan.WlanIntfOpcode.CurrentOperationMode); }
            }
            ...
            ///     An exception with code 0x0000139F (The group or resource is not in the correct state
            ///     to perform the requested operation.) will be thrown if the interface is not connected to a network.
            /// </exception>
                ...
                get
                {
                    ...
                    Wlan.ThrowIfError(
                        Wlan.WlanQueryInterface(client.clientHandle, info.interfaceGuid,
                            Wlan.WlanIntfOpcode.CurrentConnection, IntPtr.Zero, out valueSize, out valuePtr,
                            out opcodeValueType));
                    try
                    {
                        return
                            (Wlan.WlanConnectionAttributes)
                            Marshal.PtrToStructure(valuePtr, typeof(Wlan.WlanConnectionAttributes));
                    }
                    finally
                    {
            ...
            /// <summary>
            ///     The GUID of the interface (same content as the <see cref="System.Net.NetworkInformation.NetworkInterface.Id" />
            ///     value).
            /// </summary>
            ...
            public string DisplayName => InterfaceName + " (" + InterfaceDescription + ")";
            ...
            private void SetInterfaceInt(Wlan.WlanIntfOpcode opCode, int value)
            {
                ...
                {
                    Wlan.ThrowIfError(
                        Wlan.WlanSetInterface(client.clientHandle, info.interfaceGuid, opCode, sizeof(int), valuePtr,
                            IntPtr.Zero));
                }
                finally
                {
            ...
            private int GetInterfaceInt(Wlan.WlanIntfOpcode opCode)
            {
                ...
                Wlan.WlanOpcodeValueType opcodeValueType;
                Wlan.ThrowIfError(
                    Wlan.WlanQueryInterface(client.clientHandle, info.interfaceGuid, opCode, IntPtr.Zero, out valueSize,
                        out valuePtr, out opcodeValueType));
                try
                {
            ...
            {
                var availNetListHeader =
                    (Wlan.WlanAvailableNetworkListHeader)
                    Marshal.PtrToStructure(availNetListPtr, typeof(Wlan.WlanAvailableNetworkListHeader));
                var availNetListIt = availNetListPtr.ToInt64() +
                ...
                {
                    availNets[i] =
                        (Wlan.WlanAvailableNetwork)
                        Marshal.PtrToStructure(new IntPtr(availNetListIt), typeof(Wlan.WlanAvailableNetwork));
            ...
            public Wlan.WlanAvailableNetwork[] GetAvailableNetworkList(Wlan.WlanGetAvailableNetworkFlags flags)
            {
                ...
                Wlan.ThrowIfError(
                    Wlan.WlanGetAvailableNetworkList(client.clientHandle, info.interfaceGuid, flags, IntPtr.Zero,
                        out availNetListPtr));
                try
                {
            ...
            private Wlan.WlanBssEntry[] ConvertBssListPtr(IntPtr bssListPtr)
            {
                ...
                {
                    bssEntries[i] =
                        (Wlan.WlanBssEntry) Marshal.PtrToStructure(new IntPtr(bssListIt), typeof(Wlan.WlanBssEntry));
            ...
            public Wlan.WlanBssEntry[] GetNetworkBssList()
            {
                IntPtr bssListPtr;
                Wlan.ThrowIfError(
                    Wlan.WlanGetNetworkBssList(client.clientHandle, info.interfaceGuid, IntPtr.Zero,
                        Wlan.Dot11BssType.Any, false, IntPtr.Zero, out bssListPtr));
                try
                {
                ...
                bool securityEnabled)
            {
                ...
                try
                {
                    IntPtr bssListPtr;
                    Wlan.ThrowIfError(
                        Wlan.WlanGetNetworkBssList(client.clientHandle, info.interfaceGuid, ssidPtr, bssType,
                            securityEnabled, IntPtr.Zero, out bssListPtr));
                    try
                    {
                        return ConvertBssListPtr(bssListPtr);
                    }
                        ...
                        lock (eventQueue)
                        {
                            while (eventQueue.Count != 0)
                            {
                                ...
                                if (e is WlanConnectionNotificationEventData)
                                {
                                    ...
                                    if (wlanConnectionData.notifyData.notificationSource ==
                                        Wlan.WlanNotificationSource.ACM)
                                        switch (
                                            (Wlan.WlanNotificationCodeAcm)
                                            wlanConnectionData.notifyData.notificationCode)
                                        {
                                            case Wlan.WlanNotificationCodeAcm.ConnectionComplete:
            ...
            ///     On Windows XP SP2, the supplied name must match the profile name derived automatically from the SSID of the
            ///     network. For an infrastructure network profile, the SSID must be supplied for the profile name. For an ad hoc
            ///     network profile, the supplied name must be the SSID of the ad hoc network followed by <c>-adhoc</c>.
            /// </param>
            ...
            /// <param name="profileXml">
            ///     The XML representation of the profile. On Windows XP SP 2, special care should be taken to
            ///     adhere to its limitations.
            /// </param>
            /// <param name="overwrite">
            ///     If a profile by the given name already exists, then specifies whether to overwrite it (if
            ///     <c>true</c>) or return an error (if <c>false</c>).
            /// </param>
            ...
            public Wlan.WlanReasonCode SetProfile(Wlan.WlanProfileFlags flags, string profileXml, bool overwrite)
            {
                ...
                Wlan.ThrowIfError(
                    Wlan.WlanSetProfile(client.clientHandle, info.interfaceGuid, flags, profileXml, null, overwrite,
                        IntPtr.Zero, out reasonCode));
                return reasonCode;
            }
            ...
            {
                Wlan.ThrowIfError(
                    Wlan.WlanSetProfileEapXmlUserData(client.clientHandle, info.interfaceGuid,
                        profileName + char.MinValue, flags, eapXmlUserData, IntPtr.Zero));
            }
            ...
            public string GetProfileXml(string profileName)
            {
                ...
                Wlan.ThrowIfError(
                    Wlan.WlanGetProfile(client.clientHandle, info.interfaceGuid, profileName, IntPtr.Zero,
                        out profileXmlPtr, out flags,
                        out access));
                try
                {
            ...
            public Wlan.WlanProfileInfo[] GetProfiles()
            {
                ...
                {
                    var header =
                        (Wlan.WlanProfileInfoListHeader)
                        Marshal.PtrToStructure(profileListPtr, typeof(Wlan.WlanProfileInfoListHeader));
            ...
            public delegate void WlanConnectionNotificationEventHandler(
                Wlan.WlanNotificationData notifyData, Wlan.WlanConnectionNotificationData connNotifyData);
            ...
            public delegate void WlanReasonNotificationEventHandler(
                Wlan.WlanNotificationData notifyData, Wlan.WlanReasonCode reasonCode);
