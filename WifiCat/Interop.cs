...
namespace NativeWifi
{
    ...
    public static class Wlan
    {
        ...
        public struct WlanAvailableNetwork
        {
            ...
            ///     If multiple profiles are associated with the network, there will be multiple entries with the same SSID in the
            ///     visible network list. Profile names are case-sensitive.
            /// </summary>
            ...
            /// <summary>
            ///     Indicates why a network cannot be connected to. This member is only valid when <see cref="networkConnectable" /> is
            ///     <c>false</c>.
            /// </summary>
            ...
            ///     The maximum value of this field is 8. If more than 8 PHY types are supported, <see cref="morePhyTypes" /> must be
            ///     set to <c>true</c>.
            /// </summary>
            private readonly uint numberOfPhyTypes;

            /// <summary>
            ///     Contains an array of <see cref="Dot11PhyType" /> values that represent the PHY types supported by the available
            ///     networks.
            ///     When <see cref="numberOfPhyTypes" /> is greater than 8, this array contains only the first 8 PHY types.
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] private readonly Dot11PhyType[] dot11PhyTypes;
            ...
            ///     When this member is set to <c>true</c>, an application must call
            ///     <see cref="WlanClient.WlanInterface.GetNetworkBssList" /> to get the complete list of PHY types.
        ...
        {
            /// <summary>
            ///     Connect to the destination network even if the destination is a hidden network. A hidden network does not broadcast
            ///     its SSID. Do not use this flag if the destination network is an ad-hoc network.
            ///     <para>
            ///         If the profile specified by <see cref="WlanConnectionParameters.profile" /> is not <c>null</c>, then this
            ///         flag is ignored and the nonBroadcast profile element determines whether to connect to a hidden network.
            ///     </para>
            /// </summary>
            HiddenNetwork = 0x00000001,

            /// <summary>
            ///     Do not form an ad-hoc network. Only join an ad-hoc network if the network already exists. Do not use this flag if
            ///     the destination network is an infrastructure network.
            /// </summary>
            AdhocJoinOnly = 0x00000002,

            /// <summary>
            ///     Ignore the privacy bit when connecting to the network. Ignoring the privacy bit has the effect of ignoring whether
            ///     packets are encryption and ignoring the method of encryption used. Only use this flag when connecting to an
            ///     infrastructure network using a temporary profile.
            /// </summary>
            IgnorePrivacyBit = 0x00000004,

            /// <summary>
            ///     Exempt EAPOL traffic from encryption and decryption. This flag is used when an application must send EAPOL traffic
            ///     over an infrastructure network that uses Open authentication and WEP encryption. This flag must not be used to
            ///     connect to networks that require 802.1X authentication. This flag is only valid when
            ///     <see cref="WlanConnectionParameters.wlanConnectionMode" /> is set to
            ///     <see cref="WlanConnectionMode.TemporaryProfile" />. Avoid using this flag whenever possible.
            /// </summary>
        ...
        public struct WlanConnectionParameters
        {
            ...
            ///         <item>
            ///             <term>
            ///                 <see cref="WlanConnectionMode.Profile" />
            ///             </term>
            ///             <description>The name of the profile used for the connection.</description>
            ///         </item>
            ///         <item>
            ///             <term>
            ///                 <see cref="WlanConnectionMode.TemporaryProfile" />
            ///             </term>
            ///             <description>The XML representation of the profile used for the connection.</description>
            ///         </item>
            ///         <item>
            ///             <term>
            ///                 <see cref="WlanConnectionMode.DiscoverySecure" />,
            ///                 <see cref="WlanConnectionMode.DiscoveryUnsecure" /> or <see cref="WlanConnectionMode.Auto" />
            ///             </term>
            ///             <description>
            ///                 <c>null</c>
            ///             </description>
            ...
            ///     This field must not be <c>null</c> if <see cref="wlanConnectionMode" /> is set to
            ///     <see cref="WlanConnectionMode.DiscoverySecure" /> or <see cref="WlanConnectionMode.DiscoveryUnsecure" />.
            /// </summary>
            public IntPtr dot11SsidPtr;

            /// <summary>
            ///     Pointer to a <see cref="Dot11BssidList" /> structure that contains the list of basic service set (BSS) identifiers
            ...
            /// <summary>
            ///     A <see cref="Dot11BssType" /> value that indicates the BSS type of the network. If a profile is provided, this BSS
            ///     type must be the same as the one in the profile.
            /// </summary>
            public Dot11BssType dot11BssType;
        ...
        public struct WlanBssEntry
        {
            ...
            ///     implemented (but not necessarily enabled), the NIC must set this field to TRUE if the BSS operation complies with
        ...
        public struct WlanRateSet
        {
            ...
            ///     A basic rate is the data transfer rate that all stations in a basic service set (BSS) can use to receive frames
            ///     from the wireless medium.
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 126)] private readonly ushort[] rateSet;
        ...
        /// <summary>
        ///     Represents an error occuring during WLAN operations which indicate their failure via a
        ///     <see cref="WlanReasonCode" />.
        /// </summary>
        ...
        public struct WlanConnectionNotificationData
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)] public string profileName;
            ...
            ///     This field has a value of <see cref="WlanReasonCode.Success" /> for all connection-related notifications except
            ///     <see cref="WlanNotificationCodeAcm.ConnectionComplete" />.
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 1)] public string profileXml;
        }
        ...
        public enum Dot11PhyType : uint
        {
            ...
            /// <summary>
            ///     Specifies the end of the range that is used to define PHY types that are developed by an independent hardware
            ///     vendor (IHV).
            /// </summary>
            IHV_End = 0xffffffff
        }
        ...
        public enum Dot11AuthAlgorithm : uint
        {
            ...
            /// <summary>
            ///     Specifies an 802.11 Shared Key authentication algorithm that requires the use of a pre-shared Wired Equivalent
            ///     Privacy (WEP) key for the 802.11 authentication.
            /// </summary>
            ...
            ///     <para>
            ///         When the WPA algorithm is enabled, the 802.11 station will associate only with an access point whose beacon
            ///         or probe responses contain the authentication suite of type 1 (802.1X) within the WPA information element (IE).
            ///     </para>
            /// </summary>
            WPA = 3,

            /// <summary>
            ///     Specifies a WPA algorithm that uses preshared keys (PSK). IEEE 802.1X port authentication is performed by the
            ///     supplicant and authenticator. Cipher keys are dynamically derived through a preshared key that is used on both the
            ...
            /// <summary>
            ///     Specifies an 802.11i Robust Security Network Association (RSNA) algorithm. WPA2 is one such algorithm. IEEE 802.1X
            ///     port authentication is performed by the supplicant, authenticator, and authentication server. Cipher keys are
            ///     dynamically derived through the authentication process.
            ///     <para>This algorithm is valid only for BSS types of <see cref="Dot11BssType.Infrastructure" />.</para>
            ///     <para>
            ///         When the RSNA algorithm is enabled, the 802.11 station will associate only with an access point whose beacon
            ///         or probe responses contain the authentication suite of type 1 (802.1X) within the RSN IE.
            ///     </para>
            /// </summary>
            RSNA = 6,

            /// <summary>
            ///     Specifies an 802.11i RSNA algorithm that uses PSK. IEEE 802.1X port authentication is performed by the supplicant
            ///     and authenticator. Cipher keys are dynamically derived through a preshared key that is used on both the supplicant
            ///     and authenticator.
            ///     <para>This algorithm is valid only for BSS types of <see cref="Dot11BssType.Infrastructure" />.</para>
            ///     <para>
            ///         When the RSNA PSK algorithm is enabled, the 802.11 station will associate only with an access point whose
            ///         beacon or probe responses contain the authentication suite of type 2(preshared key) within the RSN IE.
            ///     </para>
            /// </summary>
            RSNA_PSK = 7,
        ...
        public enum Dot11CipherAlgorithm : uint
        {
            ...
            /// <summary>
            ///     Specifies a Wired Equivalent Privacy (WEP) algorithm, which is the RC4-based algorithm that is specified in the
            ///     802.11-1999 standard. This enumerator specifies the WEP cipher algorithm with a 40-bit cipher key.
            /// </summary>
            WEP40 = 0x01,

            /// <summary>
            ///     Specifies a Temporal Key Integrity Protocol (TKIP) algorithm, which is the RC4-based cipher suite that is based on
            ///     the algorithms that are defined in the WPA specification and IEEE 802.11i-2004 standard. This cipher also uses the
            ///     Michael Message Integrity Code (MIC) algorithm for forgery protection.
            /// </summary>
            TKIP = 0x02,

            /// <summary>
            ///     Specifies an AES-CCMP algorithm, as specified in the IEEE 802.11i-2004 standard and RFC 3610. Advanced Encryption
            ///     Standard (AES) is the encryption algorithm defined in FIPS PUB 197.
            /// </summary>
            CCMP = 0x04,
            ...
            /// <summary>
            ///     Specifies a Robust Security Network (RSN) Use Group Key cipher suite. For more information about the Use Group Key
            ///     cipher suite, refer to Clause 7.3.2.9.1 of the IEEE 802.11i-2004 standard.
            /// </summary>
            WPA_UseGroup = 0x100,

            /// <summary>
            ///     Specifies a Wifi Protected Access (WPA) Use Group Key cipher suite. For more information about the Use Group Key
            ///     cipher suite, refer to Clause 7.3.2.9.1 of the IEEE 802.11i-2004 standard.
            /// </summary>
            RSN_UseGroup = 0x100,
            ...
            /// <summary>
            ///     Specifies the start of the range that is used to define proprietary cipher algorithms that are developed by an
